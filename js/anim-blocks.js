jQuery(document).ready(function($) 
{
    ...
    var tlAnim1 = new TimelineMax()
        ...
        .to($anim1Img3, 0.75, { autoAlpha: 1, scale: 1, ease: Back.easeOut.config(5) });
    ...
    var $anim2Img3 = $(".scene-stepped-2 .anim-img3");
    ...
    var tlAnim2 = new TimelineMax()
        .set($anim2Img3, { scale: 0, transformOrigin: "center center" })
        .to($anim2Img1, 1, { autoAlpha: 1, ease: Power4.easeInOut })
        .to($anim2Img2, 1, { autoAlpha: 1, ease: Power4.easeInOut })
        .to($anim2Img3, 0.75, { autoAlpha: 1, scale: 1, ease: Back.easeOut.config(5) });
    ...
    var $anim3Img3 = $(".scene-stepped-3 .anim-img3");
    ...
    var tlAnim3 = new TimelineMax()
        .set($anim3Img3, { scale: 0, transformOrigin: "center center" })
        .to($anim3Img1, 1, { autoAlpha: 1, ease: Power4.easeInOut })
        .to($anim3Img2, 1, { autoAlpha: 1, ease: Power4.easeInOut })
        .to($anim3Img3, 0.75, { autoAlpha: 1, scale: 1, ease: Back.easeOut.config(5) });
    ...
    var tlAnim4 = new TimelineMax()
        ...
        .to($anim4Img3, 0.75, { autoAlpha: 1, scale: 1, ease: Back.easeOut.config(5) });
    ...
    var tlAnim5 = new TimelineMax()
        ...
        .to($anim5Img3, 0.75, { autoAlpha: 1, scale: 1, ease: Back.easeOut.config(5) });
