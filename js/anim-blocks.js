jQuery(document).ready(function($) {
  ...
  var tlAnim1 = new TimelineMax()
    ...
    .to($anim1Img1, 1, { autoAlpha: 2, x: "0", ease: Power4.easeInOut })
    .to($anim1Img3, 0.75, {
      autoAlpha: 1,
      scale: 1,
      ease: Back.easeOut.config(5)
    }, '-=0.5')
    .to($anim1Img2, 4, { autoAlpha: 1, ease: Power4.easeInOut })
    ;
  ...
  var tlAnim2 = new TimelineMax()
    ...
    .to($anim2Img1, 4, { x: '0', autoAlpha: 1, ease: Power4.easeInOut }, '-=1.5')
    ;
  ...
  var tlAnim3 = new TimelineMax()
    ...
    .to($anim3Img1, 4, { autoAlpha: 1, x: '0', ease: Power4.easeInOut })
    .to($anim3Img2, 1, {
      autoAlpha: 1,
      scale: 1,
  ...
  var tlAnim4 = new TimelineMax()
    ...
    .to($anim4Img1, 3, { autoAlpha: 1, ease: Power4.easeInOut })
    .to($anim4Img2, 2, { autoAlpha: 1, x: '0', ease: Power4.easeInOut }, '-=1.5')
    .to($anim4Img3, 0.75, {
      autoAlpha: 1,
      scale: 1,
      ease: Back.easeOut.config(3)
  ...
  var tlAnim5 = new TimelineMax()
    ...
    .to($anim5Img1, 2, { autoAlpha: 1, x: '0', ease: Power4.easeInOut })
    .to($anim5Img3, 0.75, {
      autoAlpha: 1,
      scale: 1,
      ease: Back.easeOut.config(5)
    }, '-=1')
    .to($anim5Img2, 4, { autoAlpha: 1, ease: Power4.easeInOut })
    ;
